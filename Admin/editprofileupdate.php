                          ...
                          <input type="hidden" name="id" value="<?php echo $arrdata['id']; ?>">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $arrdata['phone']; ?>" required>
                          </div>
                                             
                         <div class="form-group">
                               <label for="address">Address:</label>
                                <input type="text" class="form-control" id="address" name="address" value="<?php echo $arrdata['address']; ?>" required>
                          </div>                                                                                    
                           ...
                           <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">Cancel</button>
                               <button type="submit" class="btn btn-primary"
                                   name="profilesubmit">Save</button>         
                        </form>
        </div>
    </div>
        <?php
