...
include 'header.php';
            ...
            if (isset($_POST['publicsubmit'])) {
               ...
               $id = $_POST['id'];
                ...
                $supdate = "UPDATE public_park SET name='$name', email='$email', location='$location', vehicleno='$vehicleno' WHERE id='$id'";
...
<div class="container ">
    ...
    <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $arrdata['name']; ?>" required>
            </div>
            <div class="form-group">
                <label for="vehiclenumber">Vehicle Number:</label>
                <input type="text" class="form-control" id="vehiclenumber" name="vehicleno" value="<?php echo $arrdata['vehicleno']; ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="flat-no" name="location" value="<?php echo $arrdata['location']; ?> " required>
            </div>
            ...
            <button type="submit" class="btn btn-primary" name="publicsubmit">Done</button>
