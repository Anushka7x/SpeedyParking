...
<head>
  <title>Four-Wheeler Parking Dashboard</title>
  <meta charset="utf-8">
...
include('header.php');?>
  <div class="container">
    ...
    <div class="container">
      <div class="row">
      <div class="col-sm-12">
<h1>Four-Wheeler Parking Details</h1>
<?php $select_query = "SELECT * FROM four_wheeler";
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($row['updated_type'] == NULL) {
                  echo '<a href="recordfourwheelerexit.php?id=' . $row['id'] . '"class="btn btn-primary exit-button" >Exit</a>';
                } else {
                  echo 'Exited';
                }
                echo "</td>";
